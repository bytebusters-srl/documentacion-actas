...
\begin{itemize}[noitemsep]
    \item Asistencia.
    \item Planificación de Sprints del Semestre: Definición del cronograma general y duración de los ciclos de desarrollo.
    \item Definición de Eventos y Fases Scrum: Fechas y duraciones para el Refinamiento (Grooming), Sprint Planning, Ejecución y Aseguramiento de Calidad (QA).
    \item Documentación y Herramientas: Asignación de tiempos para documentación por sprint y planificación de la entrega final del pliego (física y web).
    \item Cierre de Sprint y Entregables: Cronograma de Finalización, Incremento, Deployment, Sprint Review y Sprint Retrospective.
...
Habiendo consolidado la planificación semestral, la duración de los ciclos de desarrollo y el calendario oficial de ceremonias y entregables, los miembros del equipo dan por aceptadas las resoluciones tomadas en la presente sesión, comprometiéndose al cumplimiento estricto del cronograma establecido.
...
\vspace{0.5cm}
\noindent \textbf{Fecha de última revisión:} Lunes, 16 de Marzo de 2026