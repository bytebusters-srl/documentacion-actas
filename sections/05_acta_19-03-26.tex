...
\begin{itemize}[noitemsep]
    \item Asistencia.
    \item Revisión de las Epics Generadas: Evaluación de los requerimientos de alto nivel y módulos principales del sistema.
    \item Revisión de las Historias de Usuario (HU): Análisis del desglose de las Epics, validación de criterios de aceptación y estimaciones preliminares.
    \item Planificación de Repositorios: Definición de la arquitectura de repositorios para Backend, Frontend y Documentación.
    \item Revisión para los Repositorios de GitHub: Establecimiento de políticas de ramas (branching), control de versiones y asignación de permisos.
    \item Organización de Carpetas Físicas y Virtuales: Estandarización de la estructura en Google Drive y manejo del archivo físico del equipo.
...
\vspace{0.5cm}
\noindent \textbf{Fecha de última revisión:} Jueves, 19 de Marzo de 2026