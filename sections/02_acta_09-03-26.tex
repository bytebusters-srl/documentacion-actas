\begin{titlepage}
    ...
    % --- FECHA FINAL ---
    \begin{center}
        {\normalsize Cochabamba, lunes 09 de marzo de 2026}
    \end{center}
\end{titlepage}
...
\subsection{Correciones al Documento de Invitación CPTIS-2302-2026}
...
\subsection{Revisión de la Propuesta de Servicios}
...
\subsection{Planificación y Plazo del Contrato}
...
\subsection{Análisis de la Propuesta Económica}
...
\subsection{Definición de Entregables y Documentación}
...
\vspace{0.5cm}
\textbf{Fecha de última revisión:} 09 de marzo de 2026